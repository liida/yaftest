<?php /* Smarty version Smarty-3.1.14, created on 2013-11-06 12:14:02
         compiled from "F:\root\hulapai\web\system\application\modules\Student\views\message\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1818527498ed568166-48555905%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68316e796351d7c992085fed0c7afb8b63ad98ac' => 
    array (
      0 => 'F:\\root\\hulapai\\web\\system\\application\\modules\\Student\\views\\message\\index.html',
      1 => 1383641147,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1818527498ed568166-48555905',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_527498ed711e42_53652655',
  'variables' => 
  array (
    'type' => 0,
    'messages' => 0,
...
<?php if ($_valid && !is_callable('content_527498ed711e42_53652655')) {function content_527498ed711e42_53652655($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'F:\\root\\hulapai\\web\\system\\application\\library\\Smarty\\plugins\\modifier.date_format.php';
?><?php echo $_smarty_tpl->getSubTemplate ("public/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<div class="pad_common">
<div class="col-tab">
<ul class="tabBut_ts cu-li">
           <li id="tab_setting_0" <?php if ($_smarty_tpl->tpl_vars['type']->value=='0'){?>class="on"<?php }?> onclick="message(0);">系统消息</li>
           <li id="tab_setting_1" <?php if ($_smarty_tpl->tpl_vars['type']->value=='1'){?>class="on"<?php }?> onclick="message(1);">通知</li>
           <li id="tab_setting_2" <?php if ($_smarty_tpl->tpl_vars['type']->value=='2'){?>class="on"<?php }?> onclick="message(2);">问卷调查</li>
           <li id="tab_setting_3" <?php if ($_smarty_tpl->tpl_vars['type']->value=='apply'){?>class="on"<?php }?> onclick="message(3);">申请</li>
</ul>
<?php if ($_smarty_tpl->tpl_vars['type']->value=='0'){?>
<div id="message_0" class="contentList">
...
<?php }elseif($_smarty_tpl->tpl_vars['type']->value=='apply'){?>
...
function message(type){
	if(type == 3) location.href='/student/apply/index';
	else if(type == 0 || type == 1 || type == 2)location.href='/student/message/index?type='+type;
}
function vote(id){
	window.top.art.dialog({
		id:'vote',
		iframe:'/student/vote/info?id='+id, 
		title:'问卷详情', 
		width:'700', 
		height:'400', 
		lock:true
