<?php /* Smarty version Smarty-3.1.14, created on 2013-11-05 11:05:13
         compiled from "F:\root\hulapai\web\system\application\modules\Admin\views\menu\add.html" */ ?>
<?php /*%%SmartyHeaderCode:132095278606936b517-73904753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '04e6e717ef90356437b7d3a6e293a95ce64c6396' => 
    array (
      0 => 'F:\\root\\hulapai\\web\\system\\application\\modules\\Admin\\views\\menu\\add.html',
      1 => 1383010989,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '132095278606936b517-73904753',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52786069422210_22856764',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52786069422210_22856764')) {function content_52786069422210_22856764($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("public/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<div class="subnav">
    <div class="content-menu ib-a blue line-x">
        <a href="<?php echo url('admin','menu','index');?>
"><em>菜单管理</em></a><span>|</span>
        <a class="on" href="javascript:;"><em>添加菜单</em></a>    
    </div>
</div>
...
<form name="myform" id="myform" action="<?php echo url('admin','menu','add');?>
" method="post">
...
" <?php if ($_smarty_tpl->tpl_vars['type']->value==$_smarty_tpl->tpl_vars['key']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['menuType']->value;?>
    ...
    <tr>
      ...
      <td><input type="text" name="info[name]" id="name" class="input-text" ></td>
		...
		<tr>
		       <th>模块名：</th>
		       <td><input type="text" name="info[module]" id="module" class="input-text" value=""></td>
		</tr>
		<tr>
		       <th>文件名：</th>
		...
		<tr>
		       <th>方法名：</th>
		       <td><input type="text" name="info[action]" id="action" class="input-text" ></td>
		</tr>
