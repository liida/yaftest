<?php /* Smarty version Smarty-3.1.14, created on 2014-01-07 15:07:24
         compiled from "F:\root\hulapai\web\system\application\views\public\selectteacher.html" */ ?>
<?php /*%%SmartyHeaderCode:2217252747fbbd7aee1-27079185%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '992958b1c834b328d2179930baeea6e4259a3387' => 
    array (
      0 => 'F:\\root\\hulapai\\web\\system\\application\\views\\public\\selectteacher.html',
      1 => 1389078439,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2217252747fbbd7aee1-27079185',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_52747fbbe0f606_39769998',
  'variables' => 
  array (
    'priv' => 0,
    'path' => 0,
    ...
    'groupEdit' => 0,
    'teachersArr' => 0,
    'selectedTeachersArr' => 0,
  ),
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52747fbbe0f606_39769998')) {function content_52747fbbe0f606_39769998($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("public/header_right.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
#selected_teacher_area #selected_teacher li .selected_del{ width: 10px;height:10px;margin: 10px 0;background: url("<?php echo $_smarty_tpl->tpl_vars['path']->value['images'];?>
...
<form name="myform" action="/public/selectTeacher?school=<?php echo $_smarty_tpl->tpl_vars['school']->value;?>
&event=<?php echo $_smarty_tpl->tpl_vars['event']->value;?>
&priv=<?php echo $_smarty_tpl->tpl_vars['priv']->value;?>
&groupEdit=<?php echo $_smarty_tpl->tpl_vars['groupEdit']->value;?>
...
var teachers = <?php echo $_smarty_tpl->tpl_vars['teachersArr']->value;?>
;
var selectedTeachers = <?php echo $_smarty_tpl->tpl_vars['selectedTeachersArr']->value;?>
;
...
$("#searchGroup").click(function(){
	...
	if(!groupname || groupname=="教师组名"){
		...
		$.get("/public/getSchoolGroup?school="+<?php echo $_smarty_tpl->tpl_vars['school']->value;?>
+"&name="+groupname,function(data){
			if(data == 0){
				alert("没有相关教师组");
			}else{
