<?php /* Smarty version Smarty-3.1.14, created on 2013-11-25 13:48:06
         compiled from "F:\root\hulapai\web\system\application\modules\Admin\views\vote\index.html" */ ?>
<?php /*%%SmartyHeaderCode:269745292e496b123e4-29157112%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff8940deee0b45337f8db0c60c0fb878852ecb2d' => 
    array (
      0 => 'F:\\root\\hulapai\\web\\system\\application\\modules\\Admin\\views\\vote\\index.html',
      1 => 1383010989,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '269745292e496b123e4-29157112',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5292e496bd58e8_57567185',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5292e496bd58e8_57567185')) {function content_5292e496bd58e8_57567185($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'F:\\root\\hulapai\\web\\system\\application\\library\\Smarty\\plugins\\modifier.truncate.php';
...
',2)">[投票详情]</a>	
			<a href="javascript:info('<?php echo $_smarty_tpl->tpl_vars['vote']->value['id'];?>
',1)">[投票统计]</a>	
			<a href="/admin/notify/send?type=2&vote=<?php echo $_smarty_tpl->tpl_vars['vote']->value['id'];?>
">[发问卷]</a>
			<a href="javascript:edit('<?php echo $_smarty_tpl->tpl_vars['vote']->value['id'];?>
')">[修改]</a>	
			<a href="javascript:confirmurl('/admin/vote/delete?id=<?php echo $_smarty_tpl->tpl_vars['vote']->value['id'];?>
', '是否删除?')">[删除]</a>
		</td>
    </tr>
<?php } ?>
